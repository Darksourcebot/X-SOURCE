#    جميع الحقوق لمطوري سورس إكس حصريا لهم فقط
    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                                     ...
                                     [Button.url("المطـور 🔗", "https://t.me/UP_UO"), Button.inline(
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("تنـصيب زد إي  🐍", data="deploy")],
                [Button.url("تحتاج مسـاعدة ❓", "https://t.me/UP_UO")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("شرح التنصيب 📺", "https://t.me/SOURCEE_X")],
                [Button.url("كروب المساعدة ❓", "https://t.me/p_ouv")],
            ],
        )
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @SOURCEE_X", alert=True)
