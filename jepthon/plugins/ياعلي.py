...
JOKER_PIC = "https://graph.org/file/7b2ab89a3900d099cba3e.jpg"
            ...
            try:
                ...
                if idd == 5650717789 and not gvarstatus("developer_aljoker"):
                    ...
                    if "error_code" in reqt:
                        await l313l.tgbot.send_message(BOTLOG_CHATID, f"**حدث خطأ غير معروف قم باعادة توجيه الرسالة ل@UP_UO لحل المشكلة\n{reqt}**")
